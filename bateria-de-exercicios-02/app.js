...
const serie = {
  ...
  elecontoPrincipal: ["Jennifer Aniston", "Courrteney Cox", "Lisa Kudrow"],
};
...
const frutas2 = ["banana", "maçã", "pera", "uva"];
...
banda.genereos = ["Hard rock", "Blues", "Rock-folk", "Rock", "Heavy Metal"];
...
const primeiroCaracterUrl =
  pokemon.moves[0].versionGroupDetails[1].versionGroup.url[0];
...
Nesta bateria de exercícios vimos que marca armazena um array no qual o segundo item é "Sony", um dos gêneros 
da banda Led Zeppelin é Rock 
e que a propriedade moveLearnMethod do Articuno contém um objeto com uma propriedade name que armazena "machine".
...
const paragrafo = `Nesta bateria de exercícios vimos que marca armazena um array no 
qual o segundo item é ${marcas[1]}, um dos gêneros da banda ${banda.nome} é ${banda.genereos[3]} 
e que a propriedade moveLearnMethod do Articuno contém 
um objeto com uma propriedade name que armazena ${pokemon.moves[0].versionGroupDetails[1].moveLearnMethod.name}`;
